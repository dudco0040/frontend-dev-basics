...
const {} = goods;  // 변수를 지정하는 const, let을 써줘야 한다.
...
const {n:fullname, c:contry} = person;   // 변수명 변경하면서 저장 
console.log(fullname, contry);
